...
public class CommunityDAO implements BoardDAO{
	...
	@Override
	public int getTotalCount(com.project.shopPage.SearchRow searchRow, Connection con) throws Exception {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public List<BoardDTO> selectList(com.project.shopPage.SearchRow searchRow, Connection con) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
