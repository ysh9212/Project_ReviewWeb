...
<div id="page-wrapper">
	<div id="main">
		<div class="container">
		<div id = "wrap">
			<form action="${pageContext.request.contextPath}/member/memberSearchPw" method="post">
			<h2> 비밀번호 찾기 </h2>
			<div class="login_content">
				<div class="search_row">
					<h3 class="search_title"><label for="id">아이디</label></h3>
					<span class="ps_box">
						<input type="text" id="id" class="int" name="id"title="아이디 입력" maxlength="20" placeholder="아이디를 입력하세요">
					</span>
				</div>
				<div class="search_row">
				...
				<div class="btn_search">
					<div class="btn_wrap">
							<input type="submit" id="btnsearch" class="btn_type" name="btnsearch" value="비밀번호 찾기">
					</div>
				</div>
