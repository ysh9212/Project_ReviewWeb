...
UDK 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 UDK 서비스의 이용과 관련하여 UDK 서비스를 제공하는 UDK 주식회사(이하 ‘UDK’)와 이를 이용하는 UDK 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 UDK 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.

UDK 서비스를 이용하시거나 UDK 서비스 회원으로 가입하실 경우 여러분은 본 약관 및 관련 운영 정책을 확인하거나 동의하게 되므로, 잠시 시간을 내시어 주의 깊게 살펴봐 주시기 바랍니다.

다양한 UDK 서비스를 즐겨보세요.</textarea>
				</div>
			</div>
				<div class="checkbox">
					<div>
				...
				<div class="textarea">
				<textarea name="message" rows="5" cols="68" readonly="readonly">정보통신망법 규정에 따라 UDK에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다. 1. 수집하는 개인정보
이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 UDK 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, UDK는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.

회원가입 시점에 UDK가 이용자로부터 수집하는 개인정보는 아래와 같습니다.
...
- 단체아이디로 회원가입 시 단체아이디, 비밀번호, 단체이름, 이메일주소, 가입인증 휴대전화번호를 필수항목으로 수집합니다. 그리고 단체 대표자명을 선택항목으로 수집합니다.</textarea>
			...
			<div class="textarea">
			<textarea name="message" rows="5" cols="68" readonly="readonly">위치정보 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 UDK 위치기반 서비스를 이용할 수 있습니다.  제 1 조 (목적)
이 약관은 UDK 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
