...
<body>
	...
	<div class="page-wrapper">
		<div id="main">
			<div class="container">
			<form id ="frm"action="./communityReviewUpdate" method="post">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="writer" name="writer" value="${rdto.writer}">
			</div>
			<div class="form-group">
				<label for="contents">Contents:</label>
				<textarea class="form-control" rows="5" id="contents" name="contents">${rdto.contents}</textarea>
			</div>		
